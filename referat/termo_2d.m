...
function[x, y, t, T] = termo_2d(
    ...
    g1  = '0',    % g1 - функция в правой части граничного условия на первой границе, задаваемая строкой символов, заключенных в одинарные кавычки, К или К/м;
    g2  = '0',    % g2 - функция в правой части граничного условия на второй границе, задаваемая строкой символов, заключенных в одинарные кавычки, К или К/м;
    g3  = '0',    % g3 - функция в правой части граничного условия на третьей границе, задаваемая строкой символов, заключенных в одинарные кавычки, К или К/м;
    g4  = '0'     % g4 - функция в правой части граничного условия на четвертой границе, задаваемая строкой символов, заключенных в одинарные кавычки, К или К/м.
)
